...
This then represents an numerical computing problem and maximum likelihood or Bayesian methods can be used to estimate parameters and conduct inference (e.g., see Pawitawn 2013; Gelman et al. 2025).  You can see how I call this model in the `compare.R` script.
